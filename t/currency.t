...
is $cldr->decimal, ',', 'Swedish decimal from format generator'; 

my $decf = $cldr->decimal_formatter;
is $decf->decimal, ',', 'Swedish decimal from decimal formatter'; 
is $decf->format(1.99), '1,99', 'formatted Swedish decimal';

my $curf = $cldr->currency_formatter(currency_code => 'SEK');
is $curf->decimal, ':', 'Swedish currency decimal from currency formatter'; 
