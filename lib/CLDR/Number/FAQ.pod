...
Users occasionally report incorrect formatting for several non-existant
locales. This is most often the result of specifying an unrecognized
combination of base language code and script/territory subtag. This will cause
the formatting to default to the base language.

Two common examples of this are en-MX (Mexican English) and es-BR (Brazilian
Spanish), which would default to en (English) and es (Spanish), respectively.
